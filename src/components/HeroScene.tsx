...
function Shape() {
  ...
  return <Float speed={1.2} rotationIntensity={0.15} floatIntensity={0.3}><mesh ref={mesh}><icosahedronGeometry args={[1.45, 2]} /><meshStandardMaterial color="#2B3EF0" metalness={0.25} roughness={0.38} /></mesh></Float>
}
